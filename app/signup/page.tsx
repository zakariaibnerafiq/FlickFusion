        ...
        <div className="md:pt-20 pt-40 h-full">
          <div className="md:grid lg:grid-cols-6 md:grid-cols-2 md:gap-6 lg:gap-6 w-full h-full">
            <div className="item lg:col-span-4 md:flex flex-col hidden justify-center gap-6">
              ...
              <p className='text-rosewater font-medium lg:text-xl text-md'>We're excited to have you here. Sign up to join our community</p>
            </div>
              ...
              <div className="max-w-sm md:ml-auto md:w-full m-auto">
                <div className="rounded-xl shadow bg-base-700">
                  <div className="flex flex-col p-6 space-y-1">
                    <h3 className='font-semibold text-2xl tracking-tight text-peach '>Create an Account</h3>
                    <p className='text-rosewater text-sm '>Already have an account? <span className='underline text-sm text-peach'><Link href="/login">Log In</Link></span></p>
                  </div>
                  ...
                  <form className = "p-6 grid gap-4 pt-0" action="">
                    ...
                    <div className="grid gap-2">
                      <label className='text-sm font-medium leading-none text-peach' htmlFor="name">Name</label>
                      <input className="flex h-9 w-full rounded-md border border-peach bg-transparent px-3 py-1 text-sm shadow-sm transition-colors placeholder-base-300 focus-visible:outline-none text-white" type="text" id='name' placeholder='John Doe' />
                    </div>
                    <div className="grid gap-2">
